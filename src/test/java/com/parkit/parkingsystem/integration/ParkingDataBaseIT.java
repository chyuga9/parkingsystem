...
public class ParkingDataBaseIT {
    ...
    private void setUpPerTest() throws Exception {
    	// ca ne peut pas aller à tous les tests
 ...
 // qu'est ce que teardown ? = Nommage spécifique pour les anciennes versions de Junit
    ...
    public void testTicketIsRegistered(){ 
        ...
        //vérifier si la place redevient disponible après
  ...
  //sans incoming process mock
    ...
    public void testParkingSpotIsAvailablesans() throws Exception{
    	...
    	//doNothing().when(ticket1).setOutTime(Instant.now());
