...
public class DBConstants {
    ...
    public static final String SAVE_TICKET = "insert into ticket(PARKING_NUMBER, VEHICLE_REG_NUMBER,IN_TIME, OUT_TIME) values(?,?,?,?)";
    ...
    public static final String GET_TICKET_TEST = "select t.VEHICLE_REG_NUMBER, p.TYPE from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? order by t.IN_TIME  limit 1";
